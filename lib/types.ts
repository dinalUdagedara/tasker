export type DraggableItemType = {
  ...
  priority: string;
  contentTitle: string;
  comments: string[]; // Changed to string[] for better flexibility
  files: string[]; // Changed to string[] for better flexibility
  assignees: string[]; // Changed to string[] for better flexibility
};
